...
ActiveRecord::Schema.define(version: 20240223103650) do
  ...
  create_table "matched_reservations", id: :serial, force: :cascade do |t|
    t.integer "first_reservation_id", null: false
    t.integer "second_reservation_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.datetime "schedule"
    t.index ["first_reservation_id"], name: "index_matched_reservations_on_first_reservation_id"
    t.index ["second_reservation_id"], name: "index_matched_reservations_on_second_reservation_id"
  end
  ...
  create_table "payments", id: :serial, force: :cascade do |t|
    ...
    t.index ["id", "voucher_id"], name: "index_payments_on_id_and_voucher_id", unique: true
  ...
  create_table "unmatched_reservation_histories", id: :serial, force: :cascade do |t|
    t.integer "reservation_id"
    t.integer "user_id"
    t.datetime "schedule"
    t.datetime "created_at", null: false
  ...
  create_table "user_infos", id: :serial, force: :cascade do |t|
    t.integer "user_id", null: false
  ...
  create_table "venue_booking_notifications", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["matched_reservation_id"], name: "index_venue_booking_notifications_on_matched_reservation_id"
    t.index ["reservation_id"], name: "index_venue_booking_notifications_on_reservation_id"
    t.index ["venue_booking_id"], name: "index_venue_booking_notifications_on_venue_booking_id"
  end
  ...
  create_table "venue_bookings", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["matched_reservation_id"], name: "index_venue_bookings_on_matched_reservation_id"
    t.index ["slug"], name: "index_venue_bookings_on_slug"
  ...
  create_table "vouchers", id: :serial, force: :cascade do |t|
    ...
    t.string "slug"
    t.float "amount", null: false
    t.index ["slug"], name: "index_vouchers_on_slug"
