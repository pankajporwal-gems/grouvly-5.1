...
user = User.create(provider: "facebook", first_name: "Test", last_name: "User", oauth_token: "fsdjlkfjlkd2143251453dfdfd", oauth_expires_at: "2024-04-21 10:33:39.959555", slug: Faker::Internet.password(min_length: 12), uid: "124578965352dfdfd58")
